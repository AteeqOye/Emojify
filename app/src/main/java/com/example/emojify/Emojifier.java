...
public class Emojifier {
    ...
    static Bitmap detectFacesandOverlayEmoji(Context context, Bitmap picture) {
        ...
        FaceDetector detector = new FaceDetector.Builder(context)
                ...
                .setClassificationType(FaceDetector.Face.CONFIDENCE_THRESHOLD)
                .build();
        ...
        // Detect the faces
        SparseArray<Face> faces = detector.findFaces ( frame);
    ...
    private static Emoji whichEmoji(Face face) {
        ...
        Timber.d("whichEmoji: smilingProb = " + face.getMouthPosition ());
        ...
        boolean smiling = face.equals (SMILING_PROB_THRESHOLD);

        boolean leftEyeClosed = face.equals (EYE_OPEN_PROB_THRESHOLD);
        boolean rightEyeClosed = face.equals (EYE_OPEN_PROB_THRESHOLD);
    ...
    private static Bitmap addBitmapToFace(Bitmap backgroundBitmap, Bitmap emojiBitmap, Face face) {
        ...
        int newEmojiWidth = (int) (emojiBitmap.getWidth ()* scaleFactor);
        ...
        float emojiPositionX = emojiBitmap.getWidth () / 2;
        float emojiPositionY = emojiBitmap.getHeight() / 3;
